...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.board.field1.setOnDragListener(MyDragListener(1, viewModel))
        binding.board.field2.setOnDragListener(MyDragListener(2, viewModel))
        binding.board.field3.setOnDragListener(MyDragListener(3, viewModel))
        binding.board.field4.setOnDragListener(MyDragListener(4, viewModel))
        binding.board.field5.setOnDragListener(MyDragListener(5, viewModel))
        binding.board.field6.setOnDragListener(MyDragListener(6, viewModel))
        binding.board.field7.setOnDragListener(MyDragListener(7, viewModel))
        binding.board.field8.setOnDragListener(MyDragListener(8, viewModel))
        binding.board.field9.setOnDragListener(MyDragListener(9, viewModel))
        binding.board.field10.setOnDragListener(MyDragListener(10, viewModel))
        binding.board.field11.setOnDragListener(MyDragListener(11, viewModel))
        binding.board.field12.setOnDragListener(MyDragListener(12, viewModel))
        binding.board.field13.setOnDragListener(MyDragListener(13, viewModel))
        binding.board.field14.setOnDragListener(MyDragListener(14, viewModel))
        binding.board.field15.setOnDragListener(MyDragListener(15, viewModel))
        binding.board.field16.setOnDragListener(MyDragListener(16, viewModel))
